      ...
      groups: [
        {
          ...
          items: ["Preocupación constante o pensamientos repetitivos", "Sensación de peligro inminente", "Dificultad para concentrarse", "Irritabilidad"]
        },
        {
          name: "Síntomas físicos",
          items: ["Palpitaciones o taquicardia", "Sudoración excesiva", "Tensión muscular", "Dificultad para respirar", "Problemas gastrointestinales", "Trastornos del sueño"]
        }
      ],
      ...
      subsections: [
        {
          ...
          items: ["Psicoterapia (como terapia cognitivo-conductual)", "Medicación (cuando es indicada por un médico)", "Técnicas de relajación y manejo del estrés", "Cambios en el estilo de vida (ejercicio, sueño, alimentación)"]
        }
      ],
