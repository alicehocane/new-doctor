...
const DISEASE_DETAILS: Record<string, { symptoms: string[], causes: string[] }> = {
  'diabetes': { 
    symptoms: ['Aumento de la sed', 'Ganas frecuentes de orinar', 'Fatiga extrema', 'Visión borrosa'], 
    causes: ['Resistencia a la insulina', 'Factores genéticos', 'Sobrepeso', 'Estilo de vida sedentario'] 
  },
  'hipertension': { 
    symptoms: ['Dolor de cabeza intenso', 'Fatiga o confusión', 'Problemas de visión', 'Dolor en el pecho'], 
    causes: ['Consumo excesivo de sal', 'Edad avanzada', 'Antecedentes familiares', 'Falta de actividad física'] 
  },
  'acne': { 
    symptoms: ['Puntos blancos o negros', 'Pápulas rojas', 'Nódulos dolorosos', 'Espinillas con pus'], 
    causes: ['Cambios hormonales', 'Ciertos medicamentos', 'Dieta', 'Estrés'] 
  },
  'ansiedad': { 
    symptoms: ['Sensación de nerviosismo', 'Aumento del ritmo cardíaco', 'Respiración acelerada', 'Problemas para dormir'], 
    causes: ['Traumas', 'Estrés por enfermedad', 'Acumulación de estrés', 'Personalidad'] 
  },
  'dolor-de-espalda': { 
    symptoms: ['Dolor muscular', 'Dolor punzante', 'Dolor que irradia a la pierna', 'Rango de movimiento limitado'], 
    causes: ['Distensión muscular', 'Hernia de disco', 'Artritis', 'Irregularidades óseas'] 
  },
  'gastritis': { 
    symptoms: ['Ardor de estómago', 'Náuseas', 'Vómitos', 'Sensación de plenitud'], 
    causes: ['Infección por H. pylori', 'Uso de analgésicos', 'Edad avanzada', 'Consumo excesivo de alcohol'] 
  },
  'migrana': { 
    symptoms: ['Dolor pulsátil intenso', 'Sensibilidad a la luz', 'Náuseas', 'Cambios visuales'], 
    causes: ['Cambios hormonales', 'Bebidas alcohólicas', 'Estrés', 'Estímulos sensoriales'] 
  },
  'gripe': { 
    symptoms: ['Fiebre', 'Dolor muscular', 'Escalofríos y sudoración', 'Tos seca o persistente'], 
    causes: ['Virus de la influenza', 'Contacto con personas infectadas', 'Sistema inmune debilitado'] 
  }
};

// Extended mapping for "Specialties that treat X" section (1-to-many)
const DISEASE_RELATED_SPECIALTIES: Record<string, string[]> = {
  'diabetes': ['Endocrinólogo', 'Nutriólogo', 'Medicina Interna'],
  'hipertension': ['Cardiólogo', 'Medicina Interna', 'Nefrologo'],
  'acne': ['Dermatólogo', 'Medicina Estética'],
  'ansiedad': ['Psiquiatra', 'Psicólogo'],
  'dolor-de-espalda': ['Traumatólogo', 'Ortopedista', 'Reumatólogo', 'Fisioterapeuta'],
  'embarazo': ['Ginecólogo'],
  'gastritis': ['Gastroenterólogo', 'Medicina Interna'],
  'migrana': ['Neurólogo'],
  'alergias': ['Alergólogo', 'Inmunólogo', 'Pediatra'],
  'varices': ['Angiólogo', 'Cirujano Vascular'],
  'calculos-renales': ['Urólogo', 'Nefrologo'],
  'gripe': ['Médico General', 'Neumólogo', 'Otorrinolaringólogo'],
  'artritis': ['Reumatólogo', 'Traumatólogo', 'Ortopedista'],
  'cancer': ['Oncólogo', 'Cirujano Oncológico', 'Radiólogo'],
  'obesidad': ['Bariatra', 'Nutriólogo', 'Endocrinólogo'],
  'asma': ['Neumólogo', 'Alergólogo', 'Pediatra'],
  'depresion': ['Psiquiatra', 'Psicólogo'],
  'fracturas': ['Traumatólogo', 'Ortopedista'],
  'cataratas': ['Oftalmólogo'],
  'caries': ['Dentista'],
  'infeccion-urinaria': ['Urólogo', 'Ginecólogo', 'Medicina Interna'],
  'psoriasis': ['Dermatólogo', 'Reumatólogo'],
  'hipotiroidismo': ['Endocrinólogo', 'Medicina Interna'],
  'arritmia': ['Cardiólogo', 'Electrofisiólogo'],
  'osteoporosis': ['Reumatólogo', 'Endocrinólogo', 'Ginecólogo'],
  'menopausia': ['Ginecólogo', 'Endocrinólogo'],
  'hemorroides': ['Proctólogo', 'Cirujano General'],
  'apendicitis': ['Cirujano General'],
  'insomnio': ['Psiquiatra', 'Neurólogo']
};
